...
export class AuthService {
  ...
  private apikey = 'AIzaSyCoWS5K523cbFaPcw17kURIBeOmEYYCOls';
  userToken: string;
  ...
  login(usuario: UsuarioModel) {
    const authData = {
      // usuario: usuario.email; // Se puede enviar de esta manera ó con ...usuario.
    ...
    ); // Esto regresa un observable // Regresa un observable
  }
